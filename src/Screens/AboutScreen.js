...
import {changeColorFon, changeColorText, changeTheme, changeWindows, onReset} from "../../Redux/About/actionsAbout";
    ...
    return (
            <ImageBackground source={image} style={styles.image}>
                <SafeAreaView style={{...styles.main,...state.theme.theme}}>
                    ...
                    <View style={{...styles.containerTextAbout,...state.background.backgroundColor}}>
                        <View style={{...styles.containerTextFonAbout,...state.windows.windows}}>
                    ...
                    <View style={styles.buttonContainerAllAbout}>
                        <View style={styles.buttonContainerAbout}>
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('blue')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('red')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('green')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('white')}}
                        ...
                        <View style={styles.buttonContainerAbout}>
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('fuchsia')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('yellow')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('lime')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('pink')}}
                        ...
                        <View style={styles.buttonContainerAbout}>
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('olive')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('grey')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('aqua')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('purple')}}
                        ...
                        <View style={styles.buttonContainerAbout}>
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('teal')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('maroon')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('orange')}}
                            ...
                            <TouchableOpacity style={{...styles.buttonAbout,...setColor('silver')}}
