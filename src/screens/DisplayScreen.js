...
import {increment, decrement, asyncIncrement} from '../redax/Display/actions';
      ...
      <SafeAreaView style={styles.main}>
        <View style={styles.containerTheme}>
          <TouchableOpacity
            ...
            <Text style={styles.textButtonTheme}>Сменить тему</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.container}>
          <Text style={styles.textDisplay}>Счётчик: {state.counter}</Text>
        </View>
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={{...styles.button, ...setColor('blue')}}
            onPress={addValue}
            disabled={state.block.disabled}>
            <Text style={styles.textButton}>Добавить</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{...styles.button, ...setColor('red')}}
            onPress={subValue}
            disabled={state.block.disabled}>
            <Text style={styles.textButton}>Убрать</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{...styles.button, ...setColor('green')}}
            onPress={asyncValue}>
            <Text style={styles.textButton}>Async</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </ImageBackground>
