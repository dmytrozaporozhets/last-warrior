...
import {CHANGE_COLOR_FON, CHANGE_COLOR_TEXT, CHANGE_THEME, CHANGE_WINDOWS, ON_RESET} from "./typesAbout";

const InitialBackgroundColorState = {
    backgroundColor: { backgroundColor: 'white'},
}

export const ChangeColorFonReducer = (state = InitialBackgroundColorState, action) => {
